...
content_img = load_image("./data/content.png")
style_img = load_image("./data/style.png")
...
target_img = load_image("./data/content.png").requires_grad_(True)


optimizer = torch.optim.Adam([target_img], lr=0.003)
epoch = 2500
img_off = config.IMG_OFF
